...
<a href="https://www.facebook.com/enggtech" target="_blank"
   style="display:inline-flex; align-items:center; justify-content:center;
          ...
          transition:opacity 0.2s; margin-right:8px;"
   onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"
   aria-label="Facebook">
  <svg viewBox="0 0 320 512" width="14" height="14" fill="#FF6A00" xmlns="http://www.w3.org/2000/svg">
...
<a href="https://www.instagram.com/enggtechofficial/" target="_blank"
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 27 26" fill="#FF6A00">
