document.addEventListener("DOMContentLoaded", () => {
  ...
  const footerHTML = '<footer class="enggtech-footer">'
    ...
    + '<a href="https://www.facebook.com/enggtech" target="_blank" rel="noopener noreferrer" class="footer-social-icon" aria-label="Facebook">'
    + '<svg viewBox="0 0 320 512" width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/></svg>'
    + '</a>'
    + '<a href="https://www.instagram.com/enggtechofficial/" target="_blank" rel="noopener noreferrer" class="footer-social-icon" aria-label="Instagram">'
    ...
    + '</a>'
    + '<a href="https://www.linkedin.com/company/enggtechofficial/" target="_blank" rel="noopener noreferrer" class="footer-social-icon" aria-label="LinkedIn">'
    + '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M20.447 20.452H16.89v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a1.98 1.98 0 0 1-1.98-1.98 1.98 1.98 0 0 1 1.98-1.98 1.98 1.98 0 0 1 1.98 1.98 1.98 1.98 0 0 1-1.98 1.98zm1.958 13.019H3.379V9h3.916v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>'
    + '</a>'
    + '</div>'
    ...
    + '<p><a class="footer-blog-link" href="https://engg-tech.com/articles/" title="Engg-Tech Singapore articles">Read Our Latest Articles &rarr;</a></p>'
    + '</div>'
...
.fab-btn { display:flex; align-items:center; gap:10px; border:none; cursor:pointer; border-radius:50px; padding:12px; width:52px; overflow:hidden; white-space:nowrap; transition:width 0.3s ease, padding 0.3s ease, box-shadow 0.2s ease; box-shadow:0 4px 16px rgba(0,0,0,0.2); }
.fab-btn:hover { width:180px; padding:12px 20px; box-shadow:0 6px 20px rgba(0,0,0,0.25); }
...
<div class="fab-stack">
  ...
  <button class="fab-btn fab-cmb" onclick="document.getElementById('cmb-popup').style.display='flex'" aria-label="Call Me Back">
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="white" style="flex-shrink:0;"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/></svg>
...
<div id="wa-popup" style="display:none;position:fixed;bottom:170px;right:24px;z-index:9999;background:#fff;border-radius:12px;padding:1.5rem;box-shadow:0 8px 32px rgba(0,0,0,0.18);width:280px;flex-direction:column;gap:0.75rem;">
  ...
  <div style="display:flex;align-items:center;gap:8px;">
    <div style="background:#25D366;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
  ...
  <input type="tel" id="waPhone" placeholder="Phone number" onkeypress="return /[0-9+\\s\\-().]/.test(event.key)" onpaste="setTimeout(()=>{this.value=this.value.replace(/[^0-9+\\s\\-().]/g,'')},0)" style="width:100%;padding:10px 12px;border:1.5px solid #d0dae6;border-radius:6px;font-size:1rem;box-sizing:border-box;outline:none;" onfocus="this.style.borderColor='#25D366'" onblur="this.style.borderColor='#d0dae6'"/>
  ...
  <button id="waSubmitBtn" onclick="submitWaCallback()" style="background:#25D366;color:#fff;border:none;padding:11px;border-radius:6px;font-size:0.95rem;font-weight:700;cursor:pointer;width:100%;" onmouseover="this.style.background='#1DA851'" onmouseout="this.style.background='#25D366'">Send My Number</button>
</div>
...
<div id="cmb-popup" style="display:none;position:fixed;bottom:90px;right:24px;z-index:9999;background:#fff;border-radius:12px;padding:1.5rem;box-shadow:0 8px 32px rgba(0,0,0,0.18);width:280px;flex-direction:column;gap:0.75rem;">
  ...
  <div style="display:flex;align-items:center;gap:8px;">
    <div style="background:#FF6A00;border-radius:50%;width:36px;height:36px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/></svg>
    </div>
  ...
  <input type="tel" id="cmbPhone" placeholder="Phone number" onkeypress="return /[0-9+\\s\\-().]/.test(event.key)" onpaste="setTimeout(()=>{this.value=this.value.replace(/[^0-9+\\s\\-().]/g,'')},0)" style="width:100%;padding:10px 12px;border:1.5px solid #d0dae6;border-radius:6px;font-size:1rem;box-sizing:border-box;outline:none;" onfocus="this.style.borderColor='#FF6A00'" onblur="this.style.borderColor='#d0dae6'"/>
  ...
  <button id="cmbSubmitBtn" onclick="submitCallBack()" style="background:#FF6A00;color:#fff;border:none;padding:11px;border-radius:6px;font-size:0.95rem;font-weight:700;cursor:pointer;width:100%;" onmouseover="this.style.background='#0A2540'" onmouseout="this.style.background='#FF6A00'">Request Call Back</button>
</div>
  `;
  ...
  window.submitWaCallback = async function() {
    ...
    await fetch('https://script.google.com/macros/s/AKfycby4XuwZWYK0MphbQbjrmO7M_9dUUrDb9MgZRMOHMAklwFzt3MNJUuohaBipWwMkYbud/exec', { method:'POST', mode:'no-cors', body:formData });
