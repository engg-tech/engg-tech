...
<!-- ================================================
     Floating Action Buttons — WhatsApp Us + Call Me Back
     Stacked bottom right, appears on every page
================================================ -->
<style>
.fab-stack {
  position: fixed;
...
.fab-btn {
  ...
  overflow: hidden;
  white-space: nowrap;
  transition: width 0.3s ease, padding 0.3s ease, box-shadow 0.2s ease;
...
<!-- WhatsApp Us Popup -->
<div id="wa-popup"
     style="display:none;position:fixed;bottom:170px;right:24px;z-index:9999;
  ...
  <div style="display:flex;align-items:center;gap:8px;margin-bottom:0.25rem;">
    ...
    <div>
      ...
      <p style="margin:0;font-size:0.75rem;color:#25D366;">● We will be in touch</p>
    </div>
  </div>
...
<div id="cmb-popup"
  ...
  <div style="display:flex;align-items:center;gap:8px;margin-bottom:0.25rem;">
    ...
    <div>
      <p style="margin:0;font-weight:700;color:#0A2540;font-size:0.95rem;">Call Me Back</p>
      <p style="margin:0;font-size:0.75rem;color:#FF6A00;">● We will call you back</p>
    </div>
  </div>
  ...
  <button id="cmbSubmitBtn"
          ...
          style="background:#FF6A00;color:#fff;border:none;padding:11px;
                 border-radius:6px;font-size:0.95rem;font-weight:700;
                 cursor:pointer;width:100%;transition:background 0.2s;"
